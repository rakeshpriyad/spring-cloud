...
public class EOSemaphoreDemo {
    public static void main(String[] args) {
        EOPrinterSemaphore eop = new EOPrinterSemaphore();
        int max =10;
    ...
    public static Thread getOddThread(int max,EOPrinterSemaphore eop){
       /* Runnable odd = () -> {
    ...
    public static Thread getEvenThread(int max,EOPrinterSemaphore eop){
        /* Runnable even = () -> {
